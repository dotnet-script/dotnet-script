...
{
    public class CompilationDependencyResolver2
    {
        private readonly ScriptProjectProvider _scriptProjectProvider;
        private readonly ICompilationReferenceReader _compilationReferenceReader;

        public CompilationDependencyResolver2(LogFactory logFactory) : this(new ScriptProjectProvider(logFactory), new CompilationReferencesReader(logFactory), logFactory)
        {
        }

        public CompilationDependencyResolver2(ScriptProjectProvider scriptProjectProvider, ICompilationReferenceReader compilationReferenceReader, LogFactory logFactory)
        {
